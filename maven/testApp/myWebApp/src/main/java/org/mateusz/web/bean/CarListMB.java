package org.mateusz.web.bean;

import org.mateusz.web.infra.model.Filter;
import org.mateusz.web.model.Car;
import org.mateusz.web.service.CarService;
...
import static org.mateusz.web.util.Utils.addDetailMessage;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                org.mateusz.web.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? org.mateusz.web.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? org.mateusz.web.infra.model.SortOrder.DESCENDING
                            : org.mateusz.web.infra.model.SortOrder.UNSORTED;
                }
