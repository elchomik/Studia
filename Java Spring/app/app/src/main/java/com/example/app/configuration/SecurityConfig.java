...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .exceptionHandling()
                .defaultAuthenticationEntryPointFor(registerAccountEntryPoint(), new AntPathRequestMatcher("/register"));
        return http.build();
    }
    ...
    public UserDetailsManager usersDetailsManager(DataSource dataSource) {
        ...
        jdbcUserDetailsManager.setUsersByUsernameQuery("select username, password, email " +
    ...
    @Bean
    public WebSecurityCustomizer webSucrityCustomizer() {
        return (web) -> web.ignoring().antMatchers("/images/**","/js/**","/webjars/**");
    }

    @Bean
    public AuthenticationEntryPoint registerAccountEntryPoint(){
